...
class IndicesCubeRenderer : GLSurfaceView.Renderer {
    ...
    override fun onSurfaceCreated(gl: GL10, config: EGLConfig) {
        ...
        val vertexShaderId: Int =
            ShaderUtils.compileVertexShader(ResourceUtils.readResource(R.raw.vertex_colorcube_shader))
        val fragmentShaderId: Int =
            ShaderUtils.compileFragmentShader(ResourceUtils.readResource(R.raw.fragment_colorcube_shader))
        //链接程序片段
