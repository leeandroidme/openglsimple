...
class VertexArrayRenderer : GLSurfaceView.Renderer {
    ...
    override fun onSurfaceCreated(gl: GL10, config: EGLConfig) {
        ...
        val vertexShaderId: Int =
            ShaderUtils.compileVertexShader(ResourceUtils.readResource(R.raw.vertex_array_shader))
        val fragmentShaderId: Int =
            ShaderUtils.compileFragmentShader(ResourceUtils.readResource(R.raw.fragment_array_shader))
        //鏈接程序片段
